...
public class SpitefulCubes extends AbstractCubes
{
    ...
    public AbstractCard GetReward(AbstractCard card, RewardItem rewardItem) {
        ...
        {
            final PCLRuntimeLoadout loadout = PGR.PCL.Dungeon.GetLoadout(c.series);
            if (loadout != null)
            {
                ...
                final AbstractCard reward = PGR.PCL.Dungeon.GetRandomRewardCard(rewardItem.cards, true,true);
