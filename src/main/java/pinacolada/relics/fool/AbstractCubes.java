...
public abstract class AbstractCubes extends FoolRelic
{
    ...
    {
        return CanReroll() && !PCLGameUtilities.InBattle() && rewardItem != null && (rewardItem.type == RewardItem.RewardType.CARD || rewardItem.type == PGR.Enums.Rewards.SERIES_CARDS) && !_isBoss.Get(rewardItem);
    }
    ...
    public AbstractCard GetReward(AbstractCard card, RewardItem rewardItem) {
        return PGR.PCL.Dungeon.GetRandomRewardCard(rewardItem.cards, false,true);
    }
}