...
public class JumpyDumpty extends FoolCard {
    public static final PCLCardData DATA = Register(JumpyDumpty.class).SetAttack(0, CardRarity.SPECIAL, PCLAttackType.Fire, PCLCardTarget.Random).SetSeries(CardSeries.GenshinImpact);
