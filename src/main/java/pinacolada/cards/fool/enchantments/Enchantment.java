package pinacolada.cards.fool.enchantments;
...
import pinacolada.relics.fool.UsefulBox;
...
public abstract class Enchantment extends FoolCard implements Hidden
{
    ...
    {
        return Register(type).SetPower(-2, CardRarity.SPECIAL).SetImagePath(PGR.GetCardImage(ID));
    }
