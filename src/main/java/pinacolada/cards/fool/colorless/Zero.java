...
import pinacolada.cards.fool.special.OrbCore_Frost;
import pinacolada.cards.fool.special.SheerCold;
import pinacolada.cards.fool.tokens.AffinityToken_Blue;
import pinacolada.cards.pcl.replacement.Enlightenment;
import pinacolada.resources.PGR;
import pinacolada.utilities.PCLActions;
import pinacolada.utilities.PCLGameUtilities;

public class Zero extends FoolCard
{
    ...
    protected void FindCards(RotatingList<AbstractCard> cards, AbstractMonster target)
    {
        ...
        {
            if (c.type == CardType.SKILL && PCLGameUtilities.IsPlayable(c, target) && !c.tags.contains(PGR.Enums.CardTags.VOLATILE))
            {
                cards.Add(c);
            }
        }
