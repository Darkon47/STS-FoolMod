...
public class SakuraKinomoto extends FoolCard
{
    ...
    public void OnUse(AbstractPlayer p, AbstractMonster m, CardUseInfo info)
    {
        ...
        .AddCallback(enemy ->
        {
            if (PCLGameUtilities.InEliteOrBossRoom() && PCLGameUtilities.IsFatal(enemy, false) && CombatStats.CanActivateLimited(cardID))
            {
                ...
                {
                    final AbstractCard card = PGR.PCL.Dungeon.GetRandomRewardCard(choices.group, true, true);
                    if (card != null)
                    {
                ...
                .SetMessage(PGR.PCL.Strings.GridSelection.ChooseOneCard)
