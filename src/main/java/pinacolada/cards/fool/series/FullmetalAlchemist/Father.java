...
public class Father extends FoolCard implements OnAddToDeckListener, OnAddingToCardRewardListener
{
    ...
    {
        final boolean add = !PGR.PCL.Dungeon.BannedCards.contains(cardID);
        PGR.PCL.Dungeon.Ban(cardData.ID);
    ...
    {
        return PGR.PCL.Dungeon.BannedCards.contains(cardID) || player == null;
    }
