...
public class ZorzalElCaesar extends FoolCard
{
    ...
    public static class ZorzalElCaesarPower extends FoolClickablePower
    {
        ...
        public void OnUse(AbstractMonster m, int cost)
        {
            ...
            while (choice.size() < 3 && pool.Size() > 0)
            {
                ...
                if (temp.cost == 0 && !(temp.cardID.equals(ZorzalElCaesar.DATA.ID) || temp.tags.contains(AbstractCard.CardTags.HEALING) || temp.tags.contains(PGR.Enums.CardTags.VOLATILE))) {
