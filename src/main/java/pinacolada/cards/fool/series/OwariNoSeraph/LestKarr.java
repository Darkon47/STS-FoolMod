    ...
    public void OnUse(AbstractPlayer p, AbstractMonster m, CardUseInfo info)
    {
        ...
        PCLActions.Bottom.SelectFromPile(name, 1, choice)
                ...
                .AddCallback(cards ->
                {
                    ...
                    {
                        choices.AddEffect(BaseEffect.Gain(magicNumber, PCLPowerHelper.TemporaryDexterity));
                        choices.AddEffect(BaseEffect.Gain(magicNumber, PCLPowerHelper.TemporaryFocus));
                    }
                    choices.Select(1, m);
                });
    }
