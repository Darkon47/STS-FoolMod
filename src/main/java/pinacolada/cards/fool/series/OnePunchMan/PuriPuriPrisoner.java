...
public class PuriPuriPrisoner extends FoolCard
{
    public static final PCLCardData DATA = Register(pinacolada.cards.fool.series.OnePunchMan.PuriPuriPrisoner.class)
    ...
    public static class PuriPuriPrisonerPower extends FoolPower
    {
        ...
        {
            super(owner, pinacolada.cards.fool.series.OnePunchMan.PuriPuriPrisoner.DATA);
