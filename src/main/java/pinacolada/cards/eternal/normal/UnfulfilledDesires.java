...
public class UnfulfilledDesires extends EternalCard
{
    public static final PCLCardData DATA = Register(UnfulfilledDesires.class).SetSkill(2, CardRarity.RARE, PCLCardTarget.AoE);
