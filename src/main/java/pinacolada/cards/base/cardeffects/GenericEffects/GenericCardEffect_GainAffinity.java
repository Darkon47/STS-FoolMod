...
public class GenericCardEffect_GainAffinity extends GenericCardEffect
{
    public static final String ID = Register(GenericCardEffect_GainAffinity.class);

    protected ArrayList<PCLAffinity> affinities;

    public GenericCardEffect_GainAffinity(int amount, PCLAffinity... affinities)
    {
    ...
    public GenericCardEffect_GainAffinity Add(PCLAffinity newAf) {
        if (newAf != null) {
