        ...
        public static SpireReturn Prefix(AbstractPlayer.PlayerClass c, int scoreGained)
        {
            ...
            if (p >= unlockCost)
            {
                ...
                if (p > nextUnlockCost)
                {
                    ...
                    PCLJUtils.LogInfo(UnlockTrackerPatches.class, "Overflow maxes out next level");
                }
            }
            else
            {
            ...
            PCLJUtils.LogInfo(UnlockTrackerPatches.class, "[DEBUG] Total score: " + total);
            ...
            if (scoreGained > highscore)
            {
                ...
                PCLJUtils.LogInfo(UnlockTrackerPatches.class, "[DEBUG] New high score: " + scoreGained);
            }
