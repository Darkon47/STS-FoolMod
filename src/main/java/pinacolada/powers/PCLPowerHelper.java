...
public class PCLPowerHelper extends eatyourbeets.powers.PowerHelper implements TooltipObject
{
    ...
    public static final PCLPowerHelper Blur = new PCLPowerHelper(BlurPower.POWER_ID, PGR.Tooltips.Blur, PCLBlurPower::new, Behavior.TurnBased,true, false);
    ...
    public static final PCLPowerHelper Metallicize = new PCLPowerHelper(MetallicizePower.POWER_ID, PGR.Tooltips.Metallicize, PCLMetallicizePower::new, Behavior.Permanent,true, false);
    public static final PCLPowerHelper PlatedArmor = new PCLPowerHelper(PlatedArmorPower.POWER_ID, PGR.Tooltips.PlatedArmor, PCLPlatedArmorPower::new, Behavior.Permanent,true, false);
