...
public class FoolAffinityMeter extends PCLAffinityMeter
{
    ...
    public FoolAffinityMeter() {
        ...
        CurrentAffinity = new AffinityKeywordButton(new RelativeHitbox(hb, ICON_SIZE, ICON_SIZE, 2.3f, 0.5f, true), PCLAffinity.General)
                .SetLevel(3)
                .SetOnClick(__ -> {
                    if (Reroll != null) {
                        Reroll.OnClick();
        ...
        NextAffinity = new AffinityKeywordButton(new RelativeHitbox(hb, ICON_SIZE, ICON_SIZE, 4.6f, 0.5f, true), PCLAffinity.General)
                .SetLevel(2)
                .SetOnClick(__ -> {
                    if (Reroll != null) {
                        Reroll.OnClick();
    ...
    public PCLAffinity Randomize(int target) {
        return target == TARGET_NEXT ? RandomizeNextAffinity() : RandomizeCurrentAffinity();
    }
    ...
    public PCLAffinity Get(int target) {
        return target == TARGET_NEXT ? GetNextAffinity() : GetCurrentAffinity();
    }
    ...
    public PCLAffinity Set(PCLAffinity affinity, int target) {
        return target == TARGET_NEXT ? SetNextAffinity(affinity) : SetCurrentAffinity(affinity);
    }
