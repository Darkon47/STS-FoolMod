...
public class CardKeywordButton extends GUIElement
{
    ...
    public CardKeywordButton(Hitbox hb, PCLCardTooltip tooltip)
    {
    ...
    public void Update()
    {
        background_button.SetInteractable(PCLGameEffects.IsEmpty() && CardCount != 0).Update();
    ...
    public void Render(SpriteBatch sb)
    {
        ...
        if (background_button.hb.hovered) {
            ...
            PCLCardTooltip.QueueTooltip(Tooltip, actualMX + 20 * Settings.scale, actualMY + 20 * Settings.scale);
        }
    }
}
